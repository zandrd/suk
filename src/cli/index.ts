...
function getVersion(): string {
	try {
		...
		const possiblePaths = [
			...
			join(__dirname, '../package.json'), // Built distribution path
...
program.name('suk').description("SUK - The Svelte UI Kit that doesn't suck").version(getVersion());
...
program.help = function (...args: any[]) {
	console.log(banner);
